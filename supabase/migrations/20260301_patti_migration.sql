-- ==========================================
-- PATTI MIGRATION: Triple → Single Patti / Double Patti / Triple Patti
-- Date: 2026-03-01
-- ==========================================
-- Run this in Supabase SQL Editor (Dashboard -> SQL Editor -> New Query)
-- This migration:
--   1. Adds 3 new bet_category enum values
--   2. Adds payout columns to game_config
--   3. Creates patti_master table with 220 valid pattis
--   4. Updates bet validation constraint
--   5. Replaces process_winners function
--   6. Replaces view_liability_report view
-- ==========================================

-- ==========================================
-- 1. EXTEND bet_category ENUM
-- ==========================================
...
BEGIN
    ...
    IF p_target = 'open' AND v_session.open_triple IS NOT NULL THEN
        ...
        -- Determine patti type of the declared open triple
        SELECT patti_type INTO v_patti_type FROM patti_master WHERE patti_number = v_session.open_triple;
